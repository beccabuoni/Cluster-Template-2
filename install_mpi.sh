...
echo "export PATH='$PATH:/mnt/software/openmpi/3.1.2/bin'" >> /users/BW840606/.bashrc
echo "export LD_LIBRARY_PATH='$LD_LIBRARY_PATH:/mnt/software/openmpi/3.1.2/lib/'" >> /users/BW840606/.bashrc
cd ..
